...
python stage2_vehicle_part_detection/scripts/s2_predict.py path/to/image.jpg
```

Or within Python:
```python
from stage2_vehicle_part_detection.scripts.s2_predict import detect_vehicle_parts
...
```bash
python stage2_vehicle_part_detection/scripts/s2_train.py
```
